...
The accuracies of the 5 predictions are:  
* `r round(cmSvmRadial$overall['Accuracy']*100,2)`% (SVMradial)  
* `r round(cmRF$overall['Accuracy']*100,2)`% (rf)  
* `r round(cmGBM$overall['Accuracy']*100,2)`% (GBM)  
* `r round(cmNB$overall['Accuracy']*100,2)`% (NB)  
* `r round(cmLDA$overall['Accuracy']*100,2)`% (LDA)  
